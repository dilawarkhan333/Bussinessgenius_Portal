...
$(document).ready(function(){$(window).scroll(function(){if($(this).scrollTop()>200){$('.js_go-top').fadeIn(200);}else{$('.js_go-top').fadeOut(200);}});$('.js_go-top').click(function(event){event.preventDefault();$('html, body').animate({scrollTop:0},300);})
$('a.go-to').click(function(){$('html, body').animate({scrollTop:$($(this).attr('href')).offset().top},500);return false;});jQuery("#nav").sticky({topSpacing:0});});$(document).on('click','.js-login-register-modal-call',function(e){e.preventDefault();var url=base_url+$(this).data("url");var redirect_url=window.location.href;var data={redirect_url:redirect_url};if(typeof $(this).data().send!='undefined'){data=$(this).data().send;}
loginRegisterContentLoad(url,data,$(this));});$(document).on('click','.js-register-checkbox-trigger',function(e){e.preventDefault();if($(this).val()==1){loginRegisterContentLoad(base_url+'overlay/signup_inv');var name=$(".js-ent-reg-form #form_first_name").val();var email=$(".js-ent-reg-form #form_email").val();var password=$(".js-ent-reg-form #password2").val();$(".js-inv-reg-form #form_first_name").val(name);$(".js-inv-reg-form #form_email").val(email);$(".js-inv-reg-form #password2").val(password);}else{var name=$(".js-inv-reg-form #form_first_name").val();var email=$(".js-inv-reg-form #form_email").val();var password=$(".js-inv-reg-form #password2").val();loginRegisterContentLoad(base_url+'overlay/signup');$(".js-ent-reg-form #form_first_name").val(name);$(".js-ent-reg-form #form_email").val(email);$(".js-ent-reg-form #password2").val(password);}});function loginRegisterContentLoad(url,data,ele){var myModal=$('#login-register-modal').modal('show');$.ajax({type:'post',url:url,data:data,dataType:'html',beforeSend:function(){myModal.find(".modal-content").html('<div class="loading"> </div>');},success:function(data){var newHtml=myModal.find(".modal-content").html(data);},error:function(){myModal.find(".modal-content").html('<div class="ain-loader"> Error </div>');}});return false;}
$(document).ready(function(){$('.js-podcast').on("click",function(){blockNum=$(this).data("count");if($("#js-audio-"+blockNum).get(0).duration>0&&!$("#js-audio-"+blockNum).get(0).paused){$("#js-audio-"+blockNum).get(0).pause();}else{$("#js-audio-"+blockNum).get(0).play();$('.audio__bar').not("#js-audio-"+blockNum).get(0).pause();}});});
